...
class EmpoweringLivesController extends Controller
{
    public function index()
    {
        ...
        $impact_story_sections = ImpactStorySection::where('page', SitePage::EMPOWERING_LIVES->value)->ordered()->get();
        $impact_story = ImpactStory::where('page', SitePage::EMPOWERING_LIVES->value)->ordered()->get();
