<x-layouts::app :title="__('Edit Content Section')">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-zinc-800">
            <form action="{{ route('admin.sections.update', $section) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" disabled value="{{ $section->section_key }}"
                    ...
                    <div>
                        ...
                        <input type="hidden" id="title" name="title" value="{{ old('title', $section->title) }}">
                    </div>
                ...
                <div class="mt-8 flex gap-3 pt-8 border-t">
                    ...
                    <a href="{{ route('admin.sections.index') }}" wire:navigate class="px-6 py-2 text-neutral-600">
                        Cancel
                    </a>
                </div>
