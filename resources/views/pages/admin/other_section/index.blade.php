<x-layouts::app :title="__('Details Sections')">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.other_sections.create') }}" wire:navigate class="inline-flex items-center gap-2 px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors">
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-zinc-800 overflow-hidden">
                    ...
                    <thead class="bg-neutral-50 dark:bg-zinc-700 border-b border-neutral-200 dark:border-neutral-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-sm font-semibold text-neutral-900 dark:text-neutral-50">{{ __('Subtitle') }}</th>
                                <th class="px-6 py-3 text-left text-sm font-semibold text-neutral-900 dark:text-neutral-50">{{ __('Page') }}</th>
                            ...
                            <tr class="hover:bg-neutral-50 dark:hover:bg-zinc-700 transition-colors">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <a href="{{ route('admin.other_sections.edit', $section) }}" wire:navigate class="inline-flex items-center gap-1 px-3 py-1 text-sm text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
            ...
            @else
                <div class="p-8 text-center">
                    ...
                    <a href="{{ route('admin.other_sections.create') }}" wire:navigate class="mt-4 inline-flex items-center gap-2 px-4 py-2 text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                        {{ __('Create one now') }}
                    </a>
                </div>
            @endif
