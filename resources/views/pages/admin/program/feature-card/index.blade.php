                ...
                @foreach ($cards as $card)
                    <div class="group rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-zinc-800 overflow-hidden hover:shadow-lg transition-shadow flex flex-col">
                        ...
                        <div class="flex-1 p-4 flex flex-col">
                            <h3 class="text-base font-bold text-neutral-900 dark:text-white mb-2 line-clamp-2">{!!  $card->title !!}</h3>
                            <p class="text-sm text-neutral-600 dark:text-neutral-400 line-clamp-2 flex-1">{{ strip_tags($card->description) }}</p>
                        </div>

                        <!-- Footer -->
                        <div class="p-4 border-t border-neutral-200 dark:border-neutral-700">
                            <div class="flex items-center gap-2 text-xs text-neutral-600 dark:text-neutral-400 mb-3 flex-wrap">
                                <span class="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded text-xs font-medium">{{ $card->page?->label() }} </span>
