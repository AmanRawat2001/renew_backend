<x-layouts::app :title="__('Create Impact Card')">
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            value="{{ old('metric_number') }}"
                            required
                        />
                        @error('metric_number')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-neutral-600 dark:text-neutral-400">{{ __('The main number or statistic to display') }}</p>
                    </div>
