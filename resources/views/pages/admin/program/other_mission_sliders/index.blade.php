    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">
                    {{ __('Manage mission story slides with images and descriptions') }}
                </p>
            </div>
                    ...
                    <select name="site_page" onchange="this.form.submit()"
                        ...
                        @foreach (\App\Enums\SitePage::cases() as $page)
                            @if ($page->value !== \App\Enums\SitePage::HOME->value)
                                <option value="{{ $page->value }}" {{ request('site_page') == $page->value ? 'selected' : '' }}>
                                    {{ $page->label() }}
                                </option>
                            @endif
                        @endforeach
                ...
                @foreach ($slides as $slide)
                    <div
                        ...
                        <div class="relative h-48 overflow-hidden bg-gray-100 dark:bg-gray-900">
                            ...
                            <!-- Badge -->
                            <div
                                class="absolute top-3 right-3 inline-block px-3 py-1 rounded-full text-xs font-semibold 
                        ...
                        <div class="p-4">
                            ...
                            <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                                {{ \Illuminate\Support\Str::words(strip_tags($slide->description), 20, '...') }}
                            </p>
                            ...
                            <div class="mt-4 flex items-center gap-2 pt-4 border-t border-neutral-200 dark:border-neutral-700">
                                <a href="{{ route('admin.other_mission_sliders.edit', $slide) }}" wire:navigate
        ...
        @else
            <div
                ...
                <svg class="mx-auto h-12 w-12 text-neutral-400 dark:text-neutral-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <p class="mt-4 text-neutral-600 dark:text-neutral-400">
                    {{ __('No mission slides yet. Create one to get started!') }}
                </p>
                <a href="{{ route('admin.other_mission_sliders.create') }}" wire:navigate
