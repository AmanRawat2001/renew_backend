<x-layouts::app :title="__('Create Mission Slide')">
    <div class="flex h-full w-full flex-1 flex-col gap-4">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-semibold text-neutral-900 dark:text-neutral-50">{{ __('Create Mission Slide') }}
                </h1>
                <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-1">{{ __('Add a new mission story slide') }}
                </p>
            </div>
            <a href="{{ route('admin.other_mission_sliders.index') }}" wire:navigate
        ...
        <div class="rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-zinc-800">
            <form action="{{ route('admin.other_mission_sliders.store') }}" method="POST" enctype="multipart/form-data"
                class="p-8">
                @csrf
                ...
                <div class="space-y-8">
                    ...
                    <div>
                        ...
                        <input type="string" id="external_link" name="external_link"
