                ...
                <div class="space-y-8">
                        ...
                        @if ($featureCard->image)
                            <div class="mt-4">
                                ...
                                <div class="rounded-lg overflow-hidden max-w-sm">
                                    <img src="{{ asset('uploads/' . $featureCard->image) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="external_link" name="external_link"
                            ...
                            placeholder="{{ __('e.g., https://example.com') }}" value="{{ old('external_link', $featureCard->external_link) }}" />
                        @error('external_link')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-neutral-600 dark:text-neutral-400">
                            {{ __('Optional URL to link when clicking on the feature card') }}</p>
                    </div>
