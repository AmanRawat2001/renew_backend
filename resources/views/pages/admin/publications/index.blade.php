<x-layouts::app :title="__('Publications')">
    <div class="flex h-full w-full flex-1 flex-col gap-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-semibold text-neutral-900 dark:text-neutral-50">{{ __('Publications') }}</h1>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3 text-neutral-600 dark:text-neutral-400">
                                            <img src="{{ $slide->image ? asset('storage/' . $slide->image) : asset('images/default.png') }}"
                                                alt="{!! Str::limit(strip_tags($slide->title), 50) !!}" class="h-15 object-cover rounded" />
                                        </td>
                                        <td class="px-4 py-3 text-neutral-600 dark:text-neutral-400">
                                            {{ $slide->sequence }}</td>
